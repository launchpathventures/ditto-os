...
**Last updated:** 2026-05-14 (Reviewer/Architect fix pass — Network Superconnector Reframe brief chain corrected before build. Parent Brief 270 plus child Briefs 271-279 now make the economic-outcome thesis explicit, require `278 foundation` before production discovery/claim invites, constrain LinkedIn to pointer/user-provided/consented/API-only use, separate manual search/background watch/outbound discovery, require wrapper-step-run protections on all side-effecting seams, and remain draft pending fresh-context review + human approval.)
...
| Brief 273 — Need/Opportunity Request onboarding and manual search entry: need-first Active Request flow, outcome capture, calibration, mode choice | built (2026-05-14); fresh-context review attempt blocked by usage limit; pending review retry + human approval | Briefs 270-271; Brief 257/264-266 | Existing `JobRequestCardBlock` flow (adopt); Original Active Request framing; in-place `networkJobRequests` evolution with legacy `open` compatibility | `docs/briefs/273-need-request-onboarding-manual-search-entry.md`, `src/engine/need-request-*`, `/api/v1/network/requests`, `/network/request` |
| Brief 274 — Manual Search and Possible Connection proposals with why/evidence/risk/provenance/refine/save actions; no contact/discovery send | draft corrected (2026-05-14) | Briefs 272-273; Brief 258 | Brief 266 suggested candidates + Brief 258 scout (adopt); Possible Connection original | `docs/briefs/274-manual-search-connection-proposals.md` |
| Brief 278 foundation checkpoint — scrubber, audit, source-policy enforcement, suppression, retention/delete, email compliance, admin queue scaffold | draft corrected (2026-05-14); must pass before Brief 279 production discovery/invites | Briefs 272-274 + 261 | Brief 108 admin oversight + Brief 258 privacy + Brief 261 refusal controls + FTC CAN-SPAM + LinkedIn/source-policy constraints | `docs/briefs/278-trust-privacy-admin-observability.md` |
| Brief 279 — Outbound Discovery and Claim Invites: public/source-registry discovery, LinkedIn pointer-only posture, Discovery Profiles, superconnector scoring, operator-reviewed claim invites | draft corrected (2026-05-14) | Briefs 272 + 274 + 278 foundation | Brief 258 scout (adopt); LinkedIn official API/User Agreement constraints (pattern); Discovery Profile original | `docs/briefs/279-outbound-discovery-claim-invites.md` |
| Brief 275 — Background Watch and Network Health: request/member watches, discovery-candidate handoff, proposal queue, quiet digest, throttles | draft corrected (2026-05-14) | Briefs 273-274 + 278 foundation + 279 | Operating Cycle Archetype (adopt); Network health original | `docs/briefs/275-background-watch-network-health.md` |
| Brief 276 — Email/chat consent and introduction facilitation: two-sided approval, off-platform email thread, natural reply and outcome feedback | draft corrected (2026-05-14) | Briefs 275 + 261 + 259 + 278 foundation | AuthorizationRequestBlock and `notifyUser` (adopt); off-platform intro original; outcome feedback for later pricing | `docs/briefs/276-email-chat-consent-introductions.md` |
| Brief 277 — Share loop and public profile conversion: LinkedIn/X/Instagram/email/site share studio, public visitor conversion paths, outcome-led share moments | draft corrected (2026-05-14) | Briefs 272 + 260 + 259 + 276 outcome feedback where available | Brief 260 share assets (adopt); recognition-led and outcome-led sharing original | `docs/briefs/277-share-loop-public-profile-conversion.md` |
| Brief 278 closeout checkpoint — final trust/privacy/admin/observability regression, dashboards, aggregate metrics, dry-run replay, review-checklist gates | draft corrected (2026-05-14); closes parent after 275-277 + 279 | Briefs 272-277 + 279 | Same as 278 foundation plus implemented-diff regression | `docs/briefs/278-trust-privacy-admin-observability.md` |
