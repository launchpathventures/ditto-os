...
| Brief 272 — Member Signal onboarding: LinkedIn/website/X/Instagram/user-provided sources, research, provenance, review, claim-token entry | draft corrected (2026-05-14) | Briefs 270-271; Brief 258; Brief 256 | Brief 258 source-grounded KB/scout (adopt); Original claim provenance | `docs/briefs/272-member-signal-onboarding-research-provenance.md` |
| Brief 273 — Need/Opportunity Request onboarding and manual search entry: need-first Active Request flow, outcome capture, calibration, mode choice | draft corrected (2026-05-14) | Briefs 270-271; Brief 257/264-266 | Existing `JobRequestCardBlock` flow (adopt); Original Active Request framing; must migrate/extend `networkJobRequests` deliberately | `docs/briefs/273-need-request-onboarding-manual-search-entry.md` |
