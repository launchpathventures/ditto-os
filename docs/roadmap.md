...
| Sub-brief 260 — Share modal + 3 voices (quiet/loud/ask) + dynamic OG renderer + downloadable PNG | pending; depends on 256 | Brief 254 unlock | Original; iconic-card-in-4-contexts is Soul Move | TBD |
| Sub-brief 261 — Introductions primitive + free counter + `AuthorizationRequestBlock.costLabel` extension + workspace upsell verbatim | pending; depends on 256 + 257 + 259 | Brief 254 unlock | Brief 248 (extend) | TBD |
