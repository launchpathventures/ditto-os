...
| Brief 226 — In-depth analyser (sub-brief #2 of 224) | draft | `docs/briefs/226-in-depth-analyser.md` | Fills in Brief 225's placeholder analyser handler |
| Brief 227 — Project memory scope + promotion (sub-brief #4 of 224) | draft | `docs/briefs/227-project-memory-scope-and-promotion.md` | Brief 224 §Sub-brief #4 territory |
