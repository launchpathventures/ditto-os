...
| Sub-brief 261 — Introductions primitive + free counter + `AuthorizationRequestBlock.costLabel` population + workspace upsell verbatim | design-ready + reviewed (2026-05-13); pending human approval; depends on 256 + 257 + 259 + 248; build follows 259 build | Brief 254 unlock | Brief 248 (`costLabel` already on primitive); Brief 259 cross-deployment seam (adopt); AC-J 4-trigger taxonomy + upsell idempotency log (original) | `docs/briefs/261-introductions-free-counter-workspace-upsell.md` |
