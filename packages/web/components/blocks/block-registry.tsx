...
export function BlockRenderer({ block, onAction }: BlockRendererProps) {
  switch (block.type) {
    ...
    case "intro-proposal-card":
      return <IntroProposalCard block={block} onAction={onAction} />;
    ...
    case "analyser_report":
      return <AnalyserReportBlockComponent block={block} onAction={onAction} />;
    case "retrofit_plan":
      return <RetrofitPlanBlockComponent block={block} onAction={onAction} />;
    default: {
